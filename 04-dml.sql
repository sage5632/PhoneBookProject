...
SELECT * FROM emp123;
DELETE FROM emp123;
-- WHERE절 없이 DELETE 수행하면 싹다 삭제
ROLLBACK;
SELECT * FROM emp123;

-- emp123으로부터 job_id가 PU로 시작되는 레콛 ㅡ삭제
DELETE FROM emp123
...
-- DELETE vs TRUNCATE
-- DELETE : Transcation의 대상 -> ROLLBACK;
-- TRUNCATE : Transcation의 대사잉 아님 -> ROLLBACk 불가
DELETE FROM emp123;
SELECT * FROM emp123;
ROLLBACK;
